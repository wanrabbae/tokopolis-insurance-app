...
<div class="vertical-menu">
    ...
    <button type="button" class="btn btn-sm px-3 font-size-16 header-item vertical-menu-btn" @click="toggleMenu">
                ...
                <template v-for="item in menuItems">
                  ...
                  ">{{ $t(item.badge.text) }}</span>
                        ...
                        <ul v-if="hasItems(item)" class="sub-menu" aria-expanded="false">
                            <li v-for="(subitem, i) of item.subItems" :key="i">
                                <nuxt-link v-if="!hasItems(subitem)" :to="subitem.link" class="side-nav-link-ref">{{ $t(subitem.label) }}</nuxt-link>
                                ...
                                <ul v-if="hasItems(subitem)" class="sub-menu mm-collapse" aria-expanded="false">
                                    <li v-for="(subSubitem, j) of subitem.subItems" :key="j">
