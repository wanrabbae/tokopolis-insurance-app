                    ...
                    <div class="d-block text-justify">
                        <form class="form-horizontal x-hidden" role="form" v-on:submit.prevent="doCreateData">
                            <div role="group" class="row form-group mb-3">
                                <label class="col-sm-2 col-lg-2 col-form-label">Key
                            ...
                            <div role="group" class="row form-group mb-3">
                                <label class="col-sm-2 col-lg-2 col-form-label">Value
                                    <label class="text-danger">*</label>
                                </label>
                                <div class="col-sm-10 col-lg-10">
                                    <input
...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: "key", label: 'Key', tdClass: 'align-middle' },
                { key: "value", label: 'Value', tdClass: 'align-middle' },
    ...
    methods: {
        ...
        async getData() {
            this.tableData = await this.$axios.$get('api/admin/config/all', {
                    params: {
        ...
        async doCreateData(e) {
            ...
            return await this.$axios.$post('api/admin/config', this.form)
                .then(response => {
        ...
        async doUpdateData(e) {
            ...
            return await this.$axios.$put(`api/admin/config/${this.form.id}`, data)
                .then(response => {
        ...
        async deleteData(id) {
            ...
            await Swal.fire({
                ...
                if (result.value) {
                    return context.$axios.delete(`/api/admin/config/${id}`)
