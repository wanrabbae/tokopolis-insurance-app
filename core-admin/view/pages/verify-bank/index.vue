...
export default {
    ...
    methods: {
        ...
        async getData() {
            this.tableData = await this.$axios.$get('api/admin/account/banks/list', {
                    params: {
        ...
        async verifikasiRekening(account_id) {
            return await this.$axios.$put(`/api/admin/account/banks/${account_id}`)
                .then(response => {
                    Swal.fire("Berhasil", "Berhasil Verifikasi Rekening", "success")
