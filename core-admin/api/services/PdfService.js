...
export default class PdfService {
    ...
    disclaimer(doc, data) {
        ...
        // doc.moveDown().text(// doc"Calon Tertanggung wajib membaca Quotation Slip ini secara keseluruhan dan wajib memberikan persetujuan secara tertulis untuk memproses penerbitan polis. " +
        ...
        doc.moveDown().text("Calon tertanggung wajib membaca isi Quotation terlebih dahulu, kami anggap calon tertanggung mengetahui dan memahami bahwa jika telah setuju terhadap Quotation ini, maka calon tertanggung wajib memberikan persetujuan secara tertulis atas proses penerbitan polis, serta calon tertanggung juga mengerti dan paham bahwa pertanggungan mulai berlaku setelah H+1 hari kerja dari tanggal pengajuan (untuk mobil baru) atau H+3 hari kerja (untuk mobil bekas) dan telah dalam status lunas pembayaran premi.", {align: "justify"})
        doc.moveDown().text("Quotation ini tunduk kepada polis asuransi yang akan diterbitkan oleh perusahaan Asuransi. Apabila terdapat perbedaan ketentuan dalam polis asuransi dan ketentuan dalam Quotation Slip ini, maka ketentuan dalam Polis Asuransi yang akan berlaku.", {align: "justify"})
        doc.moveDown().text("Apabila calon Tertanggung memiliki pertanyaan atas Quotation slip ini, mohon tidak ragu menghubungi kami melalui email support@istpro.com atau telepon (021) 79187909.", { align: "justify"})
        doc.moveDown()
