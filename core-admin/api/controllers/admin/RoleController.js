...
exports.create = async (req, res) => {
  ...
  if (roleExist != null) return res.errorBadRequest(req.polyglot.t('error.role.exist'))
...
exports.update = async (req, res) => {
  ...
  if (role == null) return res.errorBadRequest(req.polyglot.t('error.role.notfound'))
...
exports.addEndpoint = async (req, res) => {
  ...
  if(isExist) return res.errorBadRequest(req.polyglot.t('error.endpoint.exist'))
