...
const calculate = (req) => {
    const schema = Joi.object({
        ...
        price: Joi.number()
            .required()
            .label(req.polyglot.t('field.price')),
        plate: Joi.string()
            .required()
            .label(req.polyglot.t('field.plate')),
        ...
        acc: Joi.array()
            .label(req.polyglot.t('field.accessories')),
        start_date: Joi.date()
            .required()
...
const create = (req) => {
    ...
    const schema = Joi.object({
        ...
        workshop_count: Joi.number()
            .label(req.polyglot.t('field.product.workshop_count')),
    })
...
const createFeature = (req) => {
    const schema = Joi.object({
        ...
        name: Joi.string()
            .required()
            .label(req.polyglot.t('field.name')),
        type: Joi.valid('era', 'ambulance', 'call_center',
...
const createExpansion = (req) => {
    const schema = Joi.object({
        ...
        label: Joi.string()
            .required()
            .label(req.polyglot.t('field.label')),
        rate: Joi.number()
            .required()
            .label(req.polyglot.t('field.rate')),
    })
