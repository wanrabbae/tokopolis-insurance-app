...
const update = (req) => {
    ...
    const schema = Joi.object({
        ...
        gender: Joi.valid('male', 'female')
            .label(req.polyglot.t('field.gender')),
        birth_date: Joi.date()
            .label(req.polyglot.t('field.birth_date')),
        address: Joi.string()
            .label(req.polyglot.t('field.address')),
        phone: Joi.number()
            .label(req.polyglot.t('field.phone')),
        city: Joi.string()
            .label(req.polyglot.t('field.city')),
        province: Joi.string()
            .label(req.polyglot.t('field.province')),
    })
...
module.exports = {
    create, update, updateAccount,
    adminUpdate, updatePassword, identity
}
