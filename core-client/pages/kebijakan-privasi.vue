            ...
            <ol class="point">
                <li>
                    ...
                    <ol class="point mb-4">
                        ...
                        <li>"Pengguna Belum Terdaftar", berarti tiap orang yang mengakses Web application Kami dan belum melakukan registrasi.</li>
                        <li>"Pengguna Terdaftar", berarti tiap orang yang mengakses dan menggunakan layanan dan jasa yang disediakan oleh Kami, serta telah melakukan registrasi dan memiliki akun pada Web application Kami.</li>
                        <li>"Pihak Ketiga", berarti pihak lainnya, termasuk namun tidak terbatas pihak perusahaan asuransi, agen/mitra asuransi, atau pihak lain yang menunjang layanannya dalam Web application ini.</li>
                        <li>"Informasi Pribadi", berarti tiap dan seluruh data pribadi yang diberikan oleh Pengguna di Web application Kami, termasuk namun tidak terbatas pada nama lengkap, tempat dan tanggal lahir, jenis kelamin, alamat, nomor identitas, informasi debitur, kartu keluarga, akta kelahiran, surat nikah, akta, bukti kepemilikan, KTP, NPWP, surat izin usaha, surat penjaminan, data penghasilan, lokasi pengguna, kontak pengguna, data transaksi, data lainnya yang terekam dalam Web application Kami yang merujuk kepada Anda serta dokumen dan data pendukung lainnya sebagaimana diminta pada ringkasan pendaftaran akun serta pada ringkasan aplikasi pengajuan.</li>
                        ...
                        <li>"web application", berarti www.tokopolis.id.</li>
                    </ol>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ol class="point mb-4">
                        ...
                        <li>Memungkinkan Kami untuk dapat menyampaikan informasi mengenai rilis produk terbaru, atau layanan mendatang yang akan Kami sampaikan di web application.</li>
                        <li>Memungkinkan Pihak Ketiga untuk menghubungi dan membantu Anda pada saat Anda tertarik terhadap suatu produk dan menyatakan minat dengan mengirimkan Informasi Pribadi kepada Kami.</li>
                        <li>Memproses transaksi antara Anda dan Pihak Ketiga dengan dasar Pihak Ketiga membutuhkan Informasi Pribadi sebagai verifikasi dan data pendukung keputusan.</li>
                    </ol>
                </li>
                <li>
